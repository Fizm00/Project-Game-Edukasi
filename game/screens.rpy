...
screen about():
    ...
    vbox:
        ...
        ypos 0.23
        xmaximum 400
        text _("Game ini dibuat oleh kelompok 3")
        text _("yang beranggotakan:")
        text _("- Travis Zusa Zuve Saputra (22537141013)")
        text _("- Muh. Rofiif Syarof N. A. (22537141014)")
        text _("- Brandon Likurniawan (22537141016)")
        text _("- Rheisan Firnandatama R. S. (22537141021)")
        text _("- Asyhari Tahajjud (22537144001)")
        text _("- Firza Himawan (22537144003)")
